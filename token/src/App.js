...
import coinabi from "./MyToken.json";
import "./App.css";
const rpcEndpoint = "acc86b05791f417580d13bece2dd07d8"; // Replace with your custom testnet RPC endpoint
const infuraUrl = rpcEndpoint;

const App = () => {
  const [sidesl, setsidesl] = useState("Token");
  const standard_adr = "0x53e7e17eD692b5808ACD181505ABc812A674E6F2";
